  ...
  routes: [
    {
      ...
      meta: { title: "悦选本地到家服务平台", hidden: true, notNeedAuth: true }
    },
    {
      path: "/404",
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "flash-sale",
          component: () => import(/* webpackChunkName: "flash-sale" */ "@/views/flashSale/index.vue"),
          meta: { title: "限时购管理", icon: "icon-statistics" }
        },
        {
          path: "employee",
          component: () =>
